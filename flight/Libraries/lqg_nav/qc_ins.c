...
void mag_correction(const float *restrict x, const float *restrict P, const float *restrict mag,
        ...
        float *restrict xnew, float *restrict Pnew)
{
   const float x0 = 2*param[9];
   const float x1 = x[4]*x[7];
   const float x2 = x[5]*x[6];
   const float x3 = (x[4]*x[4]) - (x[7]*x[7]);
   const float x4 = (x[6]*x[6]);
   const float x5 = (x[5]*x[5]);
   const float x6 = x0*(x[4]*x[5] + x[6]*x[7]) - 2*(x1 - x2)*param[7] + (x3 + x4 - x5)*param[8] - mag[1];
   const float x7 = H[20]*P[4] + H[21]*P[5] + H[22]*P[6] + H[23]*P[7];
   const float x8 = H[20]*P[46] + H[21]*P[47] + H[22]*P[48] + H[23]*P[49];
   const float x9 = x8*H[24];
   const float x10 = H[20]*P[47] + H[21]*P[55] + H[22]*P[56] + H[23]*P[57];
   const float x11 = x10*H[25];
   const float x12 = H[20]*P[48] + H[21]*P[56] + H[22]*P[63] + H[23]*P[64];
   const float x13 = x12*H[26];
   const float x14 = H[20]*P[49] + H[21]*P[57] + H[22]*P[64] + H[23]*P[70];
   const float x15 = x14*H[27];
   const float x16 = H[24]*P[46] + H[25]*P[47] + H[26]*P[48] + H[27]*P[49];
   const float x17 = x16*H[20];
   const float x18 = H[24]*P[47] + H[25]*P[55] + H[26]*P[56] + H[27]*P[57];
   const float x19 = x18*H[21];
   const float x20 = H[24]*P[48] + H[25]*P[56] + H[26]*P[63] + H[27]*P[64];
   const float x21 = x20*H[22];
   const float x22 = H[24]*P[49] + H[25]*P[57] + H[26]*P[64] + H[27]*P[70];
   const float x23 = x22*H[23];
   const float x24 = x10*H[21] + x12*H[22] + x14*H[23] + x8*H[20] + R[7];
   const float x25 = x16*H[24] + x18*H[25] + x20*H[26] + x22*H[27] + R[8];
   const float x26 = 1.0F/(x24*x25 - (x11 + x13 + x15 + x9)*(x17 + x19 + x21 + x23));
   const float x27 = x26*(-x11 - x13 - x15 - x9);
   const float x28 = x27*x7;
   const float x29 = H[24]*P[4] + H[25]*P[5] + H[26]*P[6] + H[27]*P[7];
   const float x30 = x24*x26;
   const float x31 = x29*x30;
   const float x32 = -x0*(x[4]*x[6] - x[5]*x[7]) + 2*(x1 + x2)*param[8] + (x3 - x4 + x5)*param[7] - mag[0];
   const float x33 = x26*(-x17 - x19 - x21 - x23);
   const float x34 = x29*x33;
   const float x35 = x25*x26;
   const float x36 = x35*x7;
   const float x37 = H[20]*P[16] + H[21]*P[17] + H[22]*P[18] + H[23]*P[19];
   const float x38 = x27*x37;
   const float x39 = H[24]*P[16] + H[25]*P[17] + H[26]*P[18] + H[27]*P[19];
   const float x40 = x30*x39;
   const float x41 = x33*x39;
   const float x42 = x35*x37;
   const float x43 = H[20]*P[27] + H[21]*P[28] + H[22]*P[29] + H[23]*P[30];
   const float x44 = x27*x43;
   const float x45 = H[24]*P[27] + H[25]*P[28] + H[26]*P[29] + H[27]*P[30];
   const float x46 = x30*x45;
   const float x47 = x33*x45;
   const float x48 = x35*x43;
   const float x49 = H[20]*P[37] + H[21]*P[38] + H[22]*P[39] + H[23]*P[40];
   const float x50 = x27*x49;
   const float x51 = H[24]*P[37] + H[25]*P[38] + H[26]*P[39] + H[27]*P[40];
   ...
   const float x71 = H[20]*P[50] + H[21]*P[58] + H[22]*P[65] + H[23]*P[71];
   const float x72 = x27*x71;
   const float x73 = H[24]*P[50] + H[25]*P[58] + H[26]*P[65] + H[27]*P[71];
   const float x74 = x30*x73;
   const float x75 = x33*x73;
   const float x76 = x35*x71;
   const float x77 = H[20]*P[51] + H[21]*P[59] + H[22]*P[66] + H[23]*P[72];
   const float x78 = x27*x77;
   const float x79 = H[24]*P[51] + H[25]*P[59] + H[26]*P[66] + H[27]*P[72];
   const float x80 = x30*x79;
   const float x81 = x33*x79;
   const float x82 = x35*x77;
   const float x83 = H[20]*P[52] + H[21]*P[60] + H[22]*P[67] + H[23]*P[73];
   const float x84 = x27*x83;
   const float x85 = H[24]*P[52] + H[25]*P[60] + H[26]*P[67] + H[27]*P[73];
   const float x86 = x30*x85;
   const float x87 = x33*x85;
   const float x88 = x35*x83;
   const float x89 = H[20]*P[53] + H[21]*P[61] + H[22]*P[68] + H[23]*P[74];
   const float x90 = x27*x89;
   const float x91 = H[24]*P[53] + H[25]*P[61] + H[26]*P[68] + H[27]*P[74];
   const float x92 = x30*x91;
   const float x93 = x33*x91;
   const float x94 = x35*x89;
   const float x95 = H[20]*P[54] + H[21]*P[62] + H[22]*P[69] + H[23]*P[75];
   const float x96 = x27*x95;
   const float x97 = H[24]*P[54] + H[25]*P[62] + H[26]*P[69] + H[27]*P[75];
   const float x98 = x30*x97;
   const float x99 = x33*x97;
   const float x100 = x35*x95;
   const float x101 = x28 + x31;
   const float x102 = x34 + x36;
   const float x103 = -x101*H[24] - x102*H[20];
   const float x104 = -x101*H[25] - x102*H[21];
   const float x105 = -x101*H[26] - x102*H[22];
   const float x106 = -x101*H[27] - x102*H[23];
   const float x107 = x38 + x40;
   const float x108 = x41 + x42;
   const float x109 = -x107*H[24] - x108*H[20];
   const float x110 = -x107*H[25] - x108*H[21];
   const float x111 = -x107*H[26] - x108*H[22];
   const float x112 = -x107*H[27] - x108*H[23];
   const float x113 = x44 + x46;
   const float x114 = x47 + x48;
   const float x115 = -x113*H[24] - x114*H[20];
   const float x116 = -x113*H[25] - x114*H[21];
   const float x117 = -x113*H[26] - x114*H[22];
   const float x118 = -x113*H[27] - x114*H[23];
   const float x119 = x50 + x52;
   const float x120 = x53 + x54;
   const float x121 = -x119*H[24] - x120*H[20];
   const float x122 = -x119*H[25] - x120*H[21];
   const float x123 = -x119*H[26] - x120*H[22];
   const float x124 = -x119*H[27] - x120*H[23];
   const float x125 = x55 + x56;
   const float x126 = x57 + x58;
   const float x127 = -x125*H[25] - x126*H[21];
   const float x128 = -x125*H[26] - x126*H[22];
   const float x129 = -x125*H[27] - x126*H[23];
   const float x130 = -x125*H[24] - x126*H[20] + 1;
   const float x131 = x59 + x60;
   const float x132 = x61 + x62;
   const float x133 = -x131*H[24] - x132*H[20];
   const float x134 = -x131*H[26] - x132*H[22];
   const float x135 = -x131*H[27] - x132*H[23];
   const float x136 = -x131*H[25] - x132*H[21] + 1;
   const float x137 = x63 + x64;
   const float x138 = x65 + x66;
   const float x139 = -x137*H[24] - x138*H[20];
   const float x140 = -x137*H[25] - x138*H[21];
   const float x141 = -x137*H[27] - x138*H[23];
   const float x142 = -x137*H[26] - x138*H[22] + 1;
   const float x143 = x67 + x68;
   const float x144 = x69 + x70;
   const float x145 = -x143*H[24] - x144*H[20];
   const float x146 = -x143*H[25] - x144*H[21];
   const float x147 = -x143*H[26] - x144*H[22];
   const float x148 = -x143*H[27] - x144*H[23] + 1;
   const float x149 = x72 + x74;
   const float x150 = x75 + x76;
   const float x151 = x78 + x80;
   const float x152 = x81 + x82;
   const float x153 = x84 + x86;
   const float x154 = x87 + x88;
   const float x155 = x90 + x92;
   const float x156 = x93 + x94;
   const float x157 = -x155*H[24] - x156*H[20];
   const float x158 = -x155*H[25] - x156*H[21];
   const float x159 = -x155*H[26] - x156*H[22];
   const float x160 = -x155*H[27] - x156*H[23];
   const float x161 = x96 + x98;
   const float x162 = x100 + x99;
   ...
   xnew[16] = x[16];
   xnew[17] = x[17];
   xnew[18] = x32*(-x100 - x99) + x6*(-x96 - x98) + x[18];
   Pnew[0] = x103*P[4] + x104*P[5] + x105*P[6] + x106*P[7] + P[0];
   Pnew[1] = x103*P[16] + x104*P[17] + x105*P[18] + x106*P[19] + P[1];
   Pnew[2] = x103*P[27] + x104*P[28] + x105*P[29] + x106*P[30] + P[2];
   Pnew[3] = x103*P[37] + x104*P[38] + x105*P[39] + x106*P[40] + P[3];
   Pnew[4] = x103*P[46] + x104*P[47] + x105*P[48] + x106*P[49] + P[4];
   Pnew[5] = x103*P[47] + x104*P[55] + x105*P[56] + x106*P[57] + P[5];
   Pnew[6] = x103*P[48] + x104*P[56] + x105*P[63] + x106*P[64] + P[6];
   Pnew[7] = x103*P[49] + x104*P[57] + x105*P[64] + x106*P[70] + P[7];
   Pnew[8] = x103*P[50] + x104*P[58] + x105*P[65] + x106*P[71] + P[8];
   Pnew[9] = x103*P[51] + x104*P[59] + x105*P[66] + x106*P[72] + P[9];
   Pnew[10] = x103*P[52] + x104*P[60] + x105*P[67] + x106*P[73] + P[10];
   Pnew[11] = x103*P[53] + x104*P[61] + x105*P[68] + x106*P[74] + P[11];
   Pnew[12] = x103*P[54] + x104*P[62] + x105*P[69] + x106*P[75] + P[12];
   Pnew[13] = x109*P[16] + x110*P[17] + x111*P[18] + x112*P[19] + P[13];
   Pnew[14] = x109*P[27] + x110*P[28] + x111*P[29] + x112*P[30] + P[14];
   Pnew[15] = x109*P[37] + x110*P[38] + x111*P[39] + x112*P[40] + P[15];
   Pnew[16] = x109*P[46] + x110*P[47] + x111*P[48] + x112*P[49] + P[16];
   Pnew[17] = x109*P[47] + x110*P[55] + x111*P[56] + x112*P[57] + P[17];
   Pnew[18] = x109*P[48] + x110*P[56] + x111*P[63] + x112*P[64] + P[18];
   Pnew[19] = x109*P[49] + x110*P[57] + x111*P[64] + x112*P[70] + P[19];
   Pnew[20] = x109*P[50] + x110*P[58] + x111*P[65] + x112*P[71] + P[20];
   Pnew[21] = x109*P[51] + x110*P[59] + x111*P[66] + x112*P[72] + P[21];
   Pnew[22] = x109*P[52] + x110*P[60] + x111*P[67] + x112*P[73] + P[22];
   Pnew[23] = x109*P[53] + x110*P[61] + x111*P[68] + x112*P[74] + P[23];
   Pnew[24] = x109*P[54] + x110*P[62] + x111*P[69] + x112*P[75] + P[24];
   Pnew[25] = x115*P[27] + x116*P[28] + x117*P[29] + x118*P[30] + P[25];
   Pnew[26] = x115*P[37] + x116*P[38] + x117*P[39] + x118*P[40] + P[26];
   Pnew[27] = x115*P[46] + x116*P[47] + x117*P[48] + x118*P[49] + P[27];
   Pnew[28] = x115*P[47] + x116*P[55] + x117*P[56] + x118*P[57] + P[28];
   Pnew[29] = x115*P[48] + x116*P[56] + x117*P[63] + x118*P[64] + P[29];
   Pnew[30] = x115*P[49] + x116*P[57] + x117*P[64] + x118*P[70] + P[30];
   Pnew[31] = x115*P[50] + x116*P[58] + x117*P[65] + x118*P[71] + P[31];
   Pnew[32] = x115*P[51] + x116*P[59] + x117*P[66] + x118*P[72] + P[32];
   Pnew[33] = x115*P[52] + x116*P[60] + x117*P[67] + x118*P[73] + P[33];
   Pnew[34] = x115*P[53] + x116*P[61] + x117*P[68] + x118*P[74] + P[34];
   Pnew[35] = x115*P[54] + x116*P[62] + x117*P[69] + x118*P[75] + P[35];
   Pnew[36] = x121*P[37] + x122*P[38] + x123*P[39] + x124*P[40] + P[36];
   Pnew[37] = x121*P[46] + x122*P[47] + x123*P[48] + x124*P[49] + P[37];
   Pnew[38] = x121*P[47] + x122*P[55] + x123*P[56] + x124*P[57] + P[38];
   Pnew[39] = x121*P[48] + x122*P[56] + x123*P[63] + x124*P[64] + P[39];
   Pnew[40] = x121*P[49] + x122*P[57] + x123*P[64] + x124*P[70] + P[40];
   Pnew[41] = x121*P[50] + x122*P[58] + x123*P[65] + x124*P[71] + P[41];
   Pnew[42] = x121*P[51] + x122*P[59] + x123*P[66] + x124*P[72] + P[42];
   Pnew[43] = x121*P[52] + x122*P[60] + x123*P[67] + x124*P[73] + P[43];
   Pnew[44] = x121*P[53] + x122*P[61] + x123*P[68] + x124*P[74] + P[44];
   Pnew[45] = x121*P[54] + x122*P[62] + x123*P[69] + x124*P[75] + P[45];
   Pnew[46] = x127*P[47] + x128*P[48] + x129*P[49] + x130*P[46];
   Pnew[47] = x127*P[55] + x128*P[56] + x129*P[57] + x130*P[47];
   Pnew[48] = x127*P[56] + x128*P[63] + x129*P[64] + x130*P[48];
   Pnew[49] = x127*P[57] + x128*P[64] + x129*P[70] + x130*P[49];
   Pnew[50] = x127*P[58] + x128*P[65] + x129*P[71] + x130*P[50];
   Pnew[51] = x127*P[59] + x128*P[66] + x129*P[72] + x130*P[51];
   Pnew[52] = x127*P[60] + x128*P[67] + x129*P[73] + x130*P[52];
   Pnew[53] = x127*P[61] + x128*P[68] + x129*P[74] + x130*P[53];
   Pnew[54] = x127*P[62] + x128*P[69] + x129*P[75] + x130*P[54];
   Pnew[55] = x133*P[47] + x134*P[56] + x135*P[57] + x136*P[55];
   Pnew[56] = x133*P[48] + x134*P[63] + x135*P[64] + x136*P[56];
   Pnew[57] = x133*P[49] + x134*P[64] + x135*P[70] + x136*P[57];
   Pnew[58] = x133*P[50] + x134*P[65] + x135*P[71] + x136*P[58];
   Pnew[59] = x133*P[51] + x134*P[66] + x135*P[72] + x136*P[59];
   Pnew[60] = x133*P[52] + x134*P[67] + x135*P[73] + x136*P[60];
   Pnew[61] = x133*P[53] + x134*P[68] + x135*P[74] + x136*P[61];
   Pnew[62] = x133*P[54] + x134*P[69] + x135*P[75] + x136*P[62];
   Pnew[63] = x139*P[48] + x140*P[56] + x141*P[64] + x142*P[63];
   Pnew[64] = x139*P[49] + x140*P[57] + x141*P[70] + x142*P[64];
   Pnew[65] = x139*P[50] + x140*P[58] + x141*P[71] + x142*P[65];
   Pnew[66] = x139*P[51] + x140*P[59] + x141*P[72] + x142*P[66];
   Pnew[67] = x139*P[52] + x140*P[60] + x141*P[73] + x142*P[67];
   Pnew[68] = x139*P[53] + x140*P[61] + x141*P[74] + x142*P[68];
   Pnew[69] = x139*P[54] + x140*P[62] + x141*P[75] + x142*P[69];
   Pnew[70] = x145*P[49] + x146*P[57] + x147*P[64] + x148*P[70];
   Pnew[71] = x145*P[50] + x146*P[58] + x147*P[65] + x148*P[71];
   Pnew[72] = x145*P[51] + x146*P[59] + x147*P[66] + x148*P[72];
   Pnew[73] = x145*P[52] + x146*P[60] + x147*P[67] + x148*P[73];
   Pnew[74] = x145*P[53] + x146*P[61] + x147*P[68] + x148*P[74];
   Pnew[75] = x145*P[54] + x146*P[62] + x147*P[69] + x148*P[75];
   Pnew[76] = (-x149*H[24] - x150*H[20])*P[50] + (-x149*H[25] - x150*H[21])*P[58] + (-x149*H[26] - x150*H[22])*P[65] + (-x149*H[27] - x150*H[23])*P[71] + P[76];
   Pnew[77] = P[77];
   Pnew[78] = P[78];
   Pnew[79] = P[79];
   Pnew[80] = (-x151*H[24] - x152*H[20])*P[51] + (-x151*H[25] - x152*H[21])*P[59] + (-x151*H[26] - x152*H[22])*P[66] + (-x151*H[27] - x152*H[23])*P[72] + P[80];
   Pnew[81] = P[81];
   Pnew[82] = (-x153*H[24] - x154*H[20])*P[52] + (-x153*H[25] - x154*H[21])*P[60] + (-x153*H[26] - x154*H[22])*P[67] + (-x153*H[27] - x154*H[23])*P[73] + P[82];
   Pnew[83] = P[83];
   Pnew[84] = P[84];
   Pnew[85] = P[85];
   Pnew[86] = P[86];
   ...
   Pnew[89] = P[89];
   Pnew[90] = P[90];
   Pnew[91] = x157*P[53] + x158*P[61] + x159*P[68] + x160*P[74] + P[91];
   Pnew[92] = x157*P[54] + x158*P[62] + x159*P[69] + x160*P[75] + P[92];
   Pnew[93] = P[93];
   Pnew[94] = P[94];
   Pnew[95] = P[95];
   Pnew[96] = (-x161*H[24] - x162*H[20])*P[54] + (-x161*H[25] - x162*H[21])*P[62] + (-x161*H[26] - x162*H[22])*P[69] + (-x161*H[27] - x162*H[23])*P[75] + P[96];
}
